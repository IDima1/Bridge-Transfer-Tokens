    ...
    if (error instanceof Error) {
      switch (error.constructor) {
        ...
        case errors.BadRequestError:
          errorMessage = get(
            {
              ['not_confirmed']: t('errors.bad-request-errors.not-confirmed'),
              ['invalid_transaction']: t(
                'errors.bad-request-errors.invalid-transaction',
              ),
              ['already_redeemed']: t(
                'errors.bad-request-errors.already-redeemed',
              ),
              ['insufficient_lp_balance']: t(
                'errors.bad-request-errors.insufficient-lp-balance',
              ),
              ['tx_not_found']: t('errors.bad-request-errors.tx-not-found'),
            },
            get(error, 'code', ''),
            '',
          )
